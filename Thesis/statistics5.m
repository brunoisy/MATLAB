...
%    pHas12   = size(hasPeak(:, hasPeak(peak1,:) & hasPeak(peak2,:)),2)/N
   ...
   pHasNoPeak23 = size(hasBothPeaks(peak1:peak4, ~hasBothPeaks(peak2,:) & ~hasBothPeaks(peak3,:)),2)/size(hasBothPeaks,2)
   pHasPeak2no3 = size(hasBothPeaks(peak1:peak4, hasBothPeaks(peak2,:) & ~hasBothPeaks(peak3,:)),2)/size(hasBothPeaks,2)
   pHasPeak3no2 = size(hasBothPeaks(peak1:peak4, ~hasBothPeaks(peak2,:) & hasBothPeaks(peak3,:)),2)/size(hasBothPeaks,2)
   pHaspeak23   = size(hasBothPeaks(peak1:peak4, hasBothPeaks(peak2,:) & hasBothPeaks(peak3,:)),2)/size(hasBothPeaks,2)
end
