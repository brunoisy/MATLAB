...
% templateLc = [34.4800   57.4800   97.4800  122.4800  146.4800];%[93, 161, 262, 338, 399]*.36;%[36, 59, 99, 124, 148]; % check accuracy with melanie! shift? precision?
...
for n = 2:8
    ...
    for i = 1:length(clusterLcs(1,:))
        ...
        if tracenumber == 45
            ...
            legend([templateh,Lch],'template FD profile','trace FD profile')
            %             saveas(gcf, strcat('images/retro fitting/all/curve_',int2str(tracenumber),'.jpg'));
            %             close
