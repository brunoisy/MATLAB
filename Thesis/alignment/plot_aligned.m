...
%         saveas(gcf, strcat('images/alignment_exhaustive/misaligned/curve_',int2str(tracenumber),'.jpg'));
%     else
%         saveas(gcf, strcat('images/alignment_exhaustive/aligned/curve_',int2str(tracenumber),'.jpg'));
%     end
%     close
end