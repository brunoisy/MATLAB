...
% Plotting
% Trajectory
plot(tau1,tau2,'+') % estimated trajectory using SISR
plot(X1,X2,'k') % true trajectory
lgd = legend('stations','estimated trajectory using SIS','estimated trajectory using SISR', 'true trajectory');
lgd.FontSize = 12;